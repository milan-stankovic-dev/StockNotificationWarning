...
var require_TitleBar = __commonJS({
  "node_modules/@shopify/app-bridge-core/actions/TitleBar/index.js"(exports) {
    ...
    var TitleBar2 = (
      /** @class */
      function(_super) {
        __extends(TitleBar3, _super);
        function TitleBar3(app, options) {
        ...
        Object.defineProperty(TitleBar3.prototype, "buttons", {
          get: function() {
        ...
        Object.defineProperty(TitleBar3.prototype, "buttonsOptions", {
          get: function() {
        ...
        Object.defineProperty(TitleBar3.prototype, "options", {
          get: function() {
            return {
        ...
        Object.defineProperty(TitleBar3.prototype, "payload", {
          get: function() {
        ...
        TitleBar3.prototype.set = function(options, shouldUpdate) {
          if (shouldUpdate === void 0) {
            shouldUpdate = true;
          }
          var mergedOptions = helper_1.getMergedProps(this.options, options);
        ...
        TitleBar3.prototype.dispatch = function(action) {
          switch (action) {
            case Action.UPDATE:
              this.app.dispatch(update(this.payload));
              break;
        ...
        TitleBar3.prototype.getButton = function(button, subgroups, updateCb) {
        ...
        TitleBar3.prototype.updatePrimaryButton = function(newPayload) {
          if (!this.primary) {
            return;
          }
        ...
        TitleBar3.prototype.updateSecondaryButtons = function(newPayload) {
          if (!this.secondary) {
            return;
          }
        ...
        TitleBar3.prototype.updateBreadcrumbButton = function(newPayload) {
          if (!this.breadcrumb) {
            return;
          }
        ...
        TitleBar3.prototype.setPrimaryButton = function(newOptions) {
        ...
        TitleBar3.prototype.setSecondaryButton = function(newOptions) {
          var _this = this;
          var newButtons = newOptions || [];
        ...
        TitleBar3.prototype.setBreadcrumbs = function(breadcrumb) {
        ...
        TitleBar3.prototype.getChildButton = function(newAction, currentAction) {
          var newButtons = newAction ? [newAction] : [];
          var currentButtons = currentAction ? [currentAction] : [];
          var updatedButton = this.getUpdatedChildActions(newButtons, currentButtons);
          return updatedButton ? updatedButton[0] : void 0;
...
var require_actions2 = __commonJS({
  "node_modules/@shopify/app-bridge-core/validate/actions/index.js"(exports) {
    ...
    exports.ResourcePicker = ResourcePicker;
    var TitleBar2 = __importStar(require_titleBar());
    exports.TitleBar = TitleBar2;
...
var require_actions7 = __commonJS({
  "node_modules/@shopify/app-bridge/actions/index.js"(exports) {
    ...
    var TitleBar2 = __importStar(require_TitleBar2());
    exports.TitleBar = TitleBar2;
...
async function initApp(apiKey, host) {
  if (!host) {
  ...
  import_actions.TitleBar.create(app, { title: document.title });
  return app;
}
export {
  initApp
